...
import { Phone } from "@/localSttorage/auth";
...
`}
        ...
        <Link
          href={"/"}
          className="self-end hover:bg-[#d85241] flex lg:flex-col items-center p-3 lg:py-3 lg:px-5 mt-[110px]  lg:bg-primary lg:rounded-[5px]"
        >
