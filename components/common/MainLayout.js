        ...
        <div className=''>
            <header className='hidden lg:flex justify-between items-center px-[100px] py-5 bg-white'>
                <div className='flex items-center'>
                    ...
                    <Link href='/' className='text-base text-primary font-medium leading-8 mx-2 xl:mx-4'>
                        صفحه اصلی
                    </Link>
            ...
            <footer className='hidden lg:block bg-[#F8F8F8] px-[120px]'>
                <div className='flex justify-between pt-10 pb-[100px] border-y-[2px] border-[rgba(0, 0, 0, 0.05)]'>
                    <div>
                        ...
                        <div className='flex items-center my-2'>
                            <Image
                                ...
                                alt="Location Icon"
                            />
                            <p className='text-base text-black font-medium leading-7 mr-1'><bdi>آدرس:</bdi></p>
                            <p className='text-sm text-black font-normal leading-6 mr-2'><bdi>خیابان محمدی، جنب شعبه بانک ملی، پلاک ۱۱۰</bdi></p>
                        </div>
                        <div className='flex items-center my-2'>
                            <Image
                                src={phone_Icon}
                                alt="Phone Icon"
                            />
                            <p className='text-base text-black font-medium leading-7 mr-1'><bdi>شماره تماس:</bdi></p>
                            <p className='text-sm text-black font-normal leading-6 mr-2'><bdi>021-77788123</bdi></p>
                        </div>
                        <div className='flex items-center my-2'>
                            <Image
                                src={clock_Icon}
                                alt="Clock Icon"
                            />
                            <p className='text-base text-black font-medium leading-7 mr-1'><bdi>ساعت کاری:</bdi></p>
                            <p className='text-sm text-black font-normal leading-6 mr-2'><bdi>شنبه الی چهارشنبه ساعت 10 تا 20</bdi></p>
                        </div>
                    </div>
                    <div className='flex flex-col'>
                        <h6 className='text-2xl text-black font-bold leading-9 mb-7'><bdi>حساب کاربری</bdi></h6>
                        <Link href='/dashboard/bookmarks' className="text-base text-black font-medium leading-6 my-1">
                            علاقه مندی ها
                        </Link>
                        <Link href='/card' className="text-base text-black font-medium leading-6 my-1">
                        سبد خرید
                        </Link>
                        <Link href='/' className="text-base text-black font-medium leading-6 my-1">
                        پیگیری سفارش
                        </Link>
                        <Link href='/dashboard/wallet' className="text-base text-black font-medium leading-6 my-1">
                            کیف پول
                        </Link>
                    </div>
                    <div className='flex flex-col'>
                        <h6 className='text-2xl text-black font-bold leading-9 mb-7'><bdi>لینک های مفید</bdi></h6>
                        <Link href='/' className="text-base text-black font-medium leading-6 my-1">
                            درباره ما
                        </Link>
                        <Link href='/' className="text-base text-black font-medium leading-6 my-1">
                    ...
                    <div className='flex flex-col'>
                        <h6 className='text-2xl text-black font-bold leading-9 mb-7'><bdi>پشتیبانی</bdi></h6>
                        <Link href='/' className="text-base text-black font-medium leading-6 my-1">
                            سوالات متداول 
                        </Link>
                        <Link href='/' className="text-base text-black font-medium leading-6 my-1">
                ...
                <div className='flex flex-row-reverse justify-between items-center py-8'>
                    ...
                    <p className='text-base text-black font-medium leading-5'><bdi>© 2022, All rights reserved</bdi></p>
                </div>
            </footer>
        </div>    
    );
