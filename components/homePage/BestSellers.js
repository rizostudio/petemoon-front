...
const BestSellers = () => {
    //fake data
    const data = [
      {name:"پتمون", pic:seller_Logo ,kind:"فروشگاه مواد غذاییی سگ و گربه و اسباب بازی", score:"3"},
      {name:"پت بازار", pic:seller_Logo ,kind:"فروشگاه پوشاک و لباس حیوانات خانگی", score:"5"},
      {name:"پت استور", pic:seller_Logo ,kind:"فروشگاه مواد غذاییی سگ و گربه و اسباب بازی", score:"1"},
      {name:"پت شاپ", pic:seller_Logo ,kind:"فروشگاه پوشاک و لباس حیوانات خانگی", score:"5"},
      {name:"ایران پت", pic:seller_Logo ,kind:"فروشگاه مواد غذاییی سگ و گربه و اسباب بازی", score:"3"},
      {name:"تهران پت", pic:seller_Logo ,kind:"فروشگاه پوشاک و لباس حیوانات خانگی", score:"2"},
      {name:"پتمون", pic:seller_Logo ,kind:"فروشگاه مواد غذاییی سگ و گربه و اسباب بازی", score:"3"},
      {name:"پت بازار", pic:seller_Logo ,kind:"فروشگاه پوشاک و لباس حیوانات خانگی", score:"5"},
      {name:"پتمون", pic:seller_Logo ,kind:"فروشگاه مواد غذاییی سگ و گربه و اسباب بازی", score:"3"},
      {name:"پت بازار", pic:seller_Logo ,kind:"فروشگاه پوشاک و لباس حیوانات خانگی", score:"5"},
    ...
    const starsBoxHandler = (stars) => {
      ...
      for(let i=0; i < stars; i++) {
          starsBox.push(<Image src={StarGold_Icon} alt="GoldenStarIcon" className="w-3"/>)
      }
      for(let i=0; i < (5 - stars) ; i++) {
          starsBox.push(<Image src={StarEmpty_Icon} alt="EmptyStarIcon" className="w-3"/>)
      }
      return starsBox;
    }
    ...
    return (
        <div className='flex flex-col items-stretch lg:bg-[#DEDFE1] py-6 lg:pt-8 lg:pb-[60px]'>
          <div className='flex justify-between items-center align-middle px-10 lg:px-[120px]'>
            <h5 className='text-2xl text-black font-black lg:font-bold leading-7 before:inline-block before:w-2 lg:before:w-5 before:h-5 lg:before:h-2 before:bg-primary before:ml-1 before:rounded-[2px]'>فروشندگان برتر</h5>
              <Link
                href='/vet'  
          ...
          {/* mobile */}
          <div className='flex lg:hidden flex-row-reverse items-center justify-center lg:flex-wrap mr-10 my-3 lg:m-0 lg:my-10 lg:px-[120px] scrollbar overflow-x-scroll scrolling-touch scroll-smooth scroll-mx-10 touch-pan-x scrolling-touch'>
            {data && data.map((item,index) => 
              <div key={index} className='flex flex-col items-stretch ml-2 lg:m-4 w-[500px] lg:w-[375px] bg-[#F25642] rounded-3xl lg:shadow-shadowC'>
                ...
                <div className='flex rounded-b-3xl overflow-hidden'>
                  <div className='flex flex-col p-5'>
                    <h6 className='text-lg text-white font-black leading-6'><bdi>{item.kind}</bdi></h6>
                    <p className='text-base text-secondary font-medium leading-6 mt-1'><bdi>فروشنده برتر پتمون</bdi></p>
                    <div className='flex flex-row items-center'>
                      <Image src={StarGold_Icon} alt="Golden Star Icon" className="lg:hidden w-3"/>
                      <div className='hidden lg:flex flex-row items-center'>{starsBoxHandler(item.score)}</div>
