...
const Slider = () => {
    const data = [
            {image:Slider_Pic, title:"محصولات متنوع غذایی، بهداشتی و پوشاک", text:"خرید آسان با تخفیف ویژه و ارسال سریع در تهران", CTA:"سگ و گربه"},
            {image:'', title:"محصولات متنوع غذایی، بهداشتی و پوشاک", text:"خرید آسان با تخفیف ویژه و ارسال سریع در تهران", CTA:"ماهی"},
            {image:Slider_Pic, title:"محصولات متنوع غذایی، بهداشتی و پوشاک", text:"خرید آسان با تخفیف ویژه و ارسال سریع در تهران", CTA:"پرندگان"},
            {image:'', title:"محصولات متنوع غذایی، بهداشتی و پوشاک", text:"خرید آسان با تخفیف ویژه و ارسال سریع در تهران", CTA:"خرگوش"}
    ]
        ...
        <div className="flex flex-col items-stretch relative h-[150px] lg:h-auto p-0 mx-10 lg:m-0 lg:px-[120px] lg:pt-[40px] lg:pb-[70px] lg:bg-[#EA63521A] overflow-hidden rounded-[15px] lg:rounded-none">
            <div className="w-full h-full relative">
                {data && data.slice((currentPage - 1) * CardsPerPage, (currentPage - 1) * CardsPerPage + CardsPerPage).map((item,index) => 
                    ...
                    >
                        <Image src={item.image} alt="Slider.Pic" className="w-full h-full object-cover" />

                        <div className="flex flex-col w-[130px] lg:w-[290px] absolute right-6 top-2 lg:right-[80px] lg:top-[30%]">
                            <h2 className="text-base lg:text-3xl text-white font-bold leading-6 lg:leading-10"><bdi>{item.title}</bdi></h2>
                            <p className="text-xs lg:text-base text-white font-extralight leading-4 lg:leading-7 mt-1 mb-2 lg:mt-2 lg:mb-[60px]"><bdi>{item.text}</bdi></p>
                            <Link
                                href='/products'
                            ...
                            >
                                <bdi className="text-base lg:text-xl text-white font-bold">{item.CTA}</bdi>
                                <Image 
                                    src={export_Icon} 
                                    alt="Export Icon"
