                                    ...
                                    >
                                        <div className='flex flex-col'>
                                            <div className='flex flex-row items-center font-semibold lg:font-bold opacity-90 leading-8 mb-2 lg:m-2'>
                                                ...
                                                <p className='text-sm text-gray-400 mr-3 font-medium'><bdi>{item.kind}</bdi></p>
                                            </div>
                                            <div className='flex flex-row items-center font-semibold lg:font-bold opacity-90 leading-8 mb-2 lg:mx-2 lg:my-4'>
                                                ...
                                                <p className='text-xs lg:text-sm text-gray-400 mr-2 lg:mr-3 font-medium'><bdi>{item.sex}</bdi></p>
                                            </div>
                                        </div>
                                        <div className='flex flex-col lg:mr-10'>
                                            <div className='flex flex-row items-center font-semibold lg:font-bold opacity-90 leading-8 mb-2 lg:mx-0 lg:my-2'>
                                                ...
                                                <p className='text-xs lg:text-sm text-gray-400 mr-2 lg:mr-3 font-medium'><bdi>{item.race}</bdi></p>
                                            </div>
                    ...
                    <div className="flex flex-col items-stretch px-10 py-5 lg:px-0 lg:py-10">
                        <form onSubmit={event => event.preventDefault()}
                            ...
                            <div className='flex flex-col items-stretch lg:items-start w-full lg:w-2/3'>
                                <div className='text-right w-full my-4 lg:m-1'>                                            <label className='text-lg text-right text-black font-bold leading-8 opacity-90 mb-8 before:inline-block before:w-2 before:h-4 before:bg-primary before:ml-2 before:align-middle before:rounded-[2px]'>شرح حال</label>
                                    <FloatLabelInput
                                        type={"text"}
                                        placeholder={"شرح حال"}
                                ...
                                <div className='text-right w-full my-2 lg:m-1'>
                                    <label 
                                            className='text-lg text-right text-black font-bold leading-8 opacity-90 mb-8 before:inline-block before:w-2 before:h-4 before:bg-primary before:ml-2 before:align-middle before:rounded-[2px]'
                                    >علت مراجعه</label>
                                    <FloatLabelInput
                                        type={"text"}
                            ...
                            <div className=" lg:w-1/3 lg:mr-[80px]">
                                <div className='text-right my-2 lg:m-1 w-full'>
                                    <label 
                                        className='text-base lg:text-lg text-right text-black font-medium lg:font-bold leading-8 opacity-90 before:hidden lg:before:inline-block before:w-2 before:h-4 before:bg-primary before:ml-2 before:align-middle before:rounded-[2px]'
                                    >تصویر محل ضایعه</label>
                                    {inputError && <p className='text-[12px] text-error font-semibold leading-5 mt-1'><bdi>فرمت صحیح نمی باشد!</bdi></p>}                 
                                </div>
                                <div className='flex flex-col justify-between lg:justify-end items-stretch w-full'>
                                    ...
                                    <div className='w-full flex flex-row lg:mt-6'>                                            <button 
                                        onClick={() => {
                                                setSelectPage(true);
                                                setMedicalPage(false);
                                            }
