                            ...
                            <div className='flex flex-row lg:flex-col items-stretch w-full p-4 lg:p-5 bg-white rounded-[15px] lg:rounded-[25px] shadow-shadowB border-[1px] border-secondary border-solid lg:border-none'>
                                ...
                                <div className='flex flex-col w-full lg:mt-4 mr-3 lg:mr-0'>
                                    <div className='flex justify-between items-center content-start'>
                                        <h2 className='text-base lg:text-xl text-black font-medium lg:font-bold leading-8 before:hidden lg:before:inline-block before:w-2 before:h-5 before:bg-primary before:ml-1 before:rounded-[2px]'>{item.name}</h2>
                                        <p className='hidden lg:block text-sm text-info font-normal leading-5'><bdi>{`${item.commentsAmount} دیدگاه`}</bdi></p>
                                    </div>
                                    <div className='w-full flex lg:flex-col-reverse justify-between items-center lg:items-stretch'>
                                        <h4 className='text-xs lg:text-base text-primary font-medium leading-4 opacity-95'><bdi>{item.shortSpecialty}</bdi></h4>
                                        <div className='lg:w-full flex lg:flex-row-reverse lg:justify-between items-center'>
                                            <p className='text-xs lg:text-sm text-gray-400 font-medium leading-4 opacity-95 ml-2 lg:m-0'><bdi>{`${item.adviceAmount} مشاوره`}</bdi></p>
                                            <div className='flex items-center'>
                                                <div className='hidden lg:flex items-center'>{starsBoxHandler(item.score)}</div>
                                                <Image 
                                                    src={StarGold_Icon} 
                                                    alt="GoldenStarIcon"
                                    ...
                                    <p className='lg:hidden text-xs text-info font-normal leading-4 opacity-90 mt-1'><bdi>{`${item.commentsAmount} دیدگاه`}</bdi></p>
                                    <Link 
                                        href={`/vet/${index}`}
                                    ...
                                    >
                                        <Image 
                                            ...
                                            className='lg:hidden'
                                        />
                                        <p className='text-xs lg:text-base lg:text-center text-primary lg:text-white font-medium leading-7 mr-1 lg:mr-0'>شروع مشاوره</p>
                                    </Link>
                                </div>
                            </div>
                        </div>          
                ...
                <div>
                    <div className='flex flex-col justify-between items-stretch mt-5'>
                        ...
                        <div className='px-10 py-4 flex flex-col border-b-[1px] border-solid border-secondary pb-10'>
                            <p className="text-base text-black font-medium leading-7 mt-2">امتیاز</p>
                            <div>
                                {scoreKind.map((item, index) => 
                                    <div 
                                        key={v4()}
