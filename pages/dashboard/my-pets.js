    ...
    return (
        <DashboardLayout>
             <div className='w-full h-full flex flex-col justify-between items-stretch'>
                        ...
                        <div className='bg-white px-4 py-5 lg:p-10 mx-3 my-4 lg:mx-10 lg:my-8 rounded-[15px] lg:rounded-[25px] shadow-shadowB'>
                            <div
                                ...
                                <div className='flex flex-row-reverse items-center justify-end lg:justify-between'>
                                    <p className='hidden lg:block text-lg text-right text-black font-bold leading-8 opacity-90 after:hidden lg:after:inline-block after:w-2 after:h-4 after:bg-first after:ml-2 after:align-middle after:rounded-[2px]'><bdi>{item.general.name}</bdi></p>
                                    <div className='flex flex-row-reverse items-center'>
                                        <Link href={'/dashboard/my-pet-edit'} className="hidden lg:block p-2 border-[1px] solid border-[#4DA4F4] rounded-[12px]">
                                ...
                                <div className='flex flex-row-reverse justify-between items-stretch mt-2 lg:mt-8'>
                                    <div className={clsx('flex-col lg:flex-row-reverse justify-between items-stretch',{
                                    ...
                                    <div className='self-end'>
                                        <div className='w-[100px] h-[100px] relative overflow-hidden rounded-[10px]'>
                                            <Image src={item.general.pic? item.general.pic : PetPicPreserve} alt="PetPic" className='w-full h-full object-cover'/>
                                        </div>
                                    </div>
                                </div>
                            {/* Modals */}
                                    ...
                                    <label className="modal-box w-full absolute lg:relative inset-x-0 bottom-0 px-10 py-4 lg:p-8 mx-auto bg-white rounded-none rounded-t-[15px] lg:rounded-[20px]">                
                                        <div className='w-full flex flex-col justify-between items-stretch'>
                                            <div className='w-full flex flex-row-reverse justify-between items-center'>
                                                <p className='text-lg text-black font-medium lg:font-bold leading-7 after:hidden lg:after:inline-block after:w-2 after:h-4 after:bg-first after:ml-2 after:align-middle after:rounded-[2px]'>حذف پت</p>
                                                <label htmlFor="Trash-modal">
                                            ...
                                            <div className='flex flex-row-reverse items-center justify-between w-full lg:w-1/2'>
                                                <label htmlFor='Trash-modal' onClick={() => TrashHandler(index)} className='w-full text-sm text-white text-center font-semibold py-3 lg:py-2 lg:px-8 rounded-[5px] bg-error ml-2 border-[2px] solid border-error'>حذف پت</label>
                ...
                <Link href="/dashboard/my-pet-edit" className='w-full flex flex-row lg:flex-col justify-center items-start lg:items-center mt-10 lg:mt-2 py-5 lg:py-10 bg-first lg:bg-white rounded-[12px] lg:rounded-[25px] shadow-shadowB'>
                    <Image src={PetAdd_IconWhite} alt="PetAddIcon" className='mr-2 lg:mr-0 lg:hidden'/>
                    <Image src={PetAdd_Icon} alt="PetAddIcon" className='hidden lg:block'/>
                    <p className='text-lg lg:text-3xl text-white lg:text-first text-center font-medium lg:font-bold leading-7 lg:mt-5'>ثبت پت جدید</p>
                </Link>
            </div>
        </DashboardLayout>
    );
