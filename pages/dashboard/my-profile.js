    ...
    return (
            <DashboardLayout>
                <div className='flex flex-col justify-between items-stretch'>
                    ...
                    <div className='w-full h-full flex flex-col lg:flex-row-reverse justify-between items-center lg:my-8 lg:p-0'>
                        <form className='w-full h-full lg:h-[300px] flex flex-col lg:flex-row-reverse items:center justify-evenly'>                                    
                            <div className='w-full h-full lg:w-3/4 flex flex-col items-stretch lg:p-5 lg:ml-6 lg:px-12 lg:py-8 lg:bg-white rounded-[25px] lg:shadow-shadowA'>
                                ...
                                <div className='lg:flex flex-row-reverse justify-between items-center w-full lg:my-5'>
                                    ...
                                    <div className='text-right lg:w-1/2 my-4 lg:m-1 lg:mr-4'>
                                        <label className='hidden lg:block text-lg text-right text-black font-bold leading-8 opacity-90 after:hidden lg:after:inline-block after:w-2 after:h-4 after:bg-first after:ml-2 after:align-middle after:rounded-[2px]'>ایمیل</label>
                                        <FloatLabelInput
                                                type={"email"}
                                                placeholder={"ایمیل"}
                                                name="email"
                            ...
                            <div className='w-full h-full lg:w-1/4 relative mt-6 lg:mt-0 px-4 py-6 lg:px-3 lg:py-5 flex lg:flex-col justify-between lg:justify-center items-center bg-[#FFE2DE] lg:bg-white rounded-[12px] lg:rounded-[25px] lg:shadow-shadowA'>                                    
                                ...
                                <Image src={PenEdit_Icon} alt="PenEditIcon" className='absolute bottom-5 left-7'/>
                            </div>
                            <button type='input' className='lg:hidden w-full mt-10 py-3 bg-[#CFEBD8] text-black text-center font-medium border-[1px] solid border-verify rounded-[12px]'>ذخیره</button>
                        </form>
                    </div>
