    ...
    return (
        <DashboardLayout>
            <div className='flex flex-col justify-between items-stretch'>
                        ...
                        <div className='flex flex-row-reverse justify-between items-stretch mt-2 lg:mt-8'>
                            <div className='flex flex-col lg:flex-row-reverse lg:justify-between'>
                                <div className='flex flex-col items-end'>
                                    <div className='flex flex-row-reverse items-center font-semibold lg:font-bold opacity-90 leading-8 mb-2 lg:my-2'>
                                    ...
                                    <div className='flex flex-row-reverse items-center font-semibold lg:font-bold opacity-90 leading-8 my-2'>
                                ...
                                <div className='flex flex-col items-end lg:mr-10'>
                                    <div className='flex flex-row-reverse items-center font-semibold lg:font-bold opacity-90 leading-8 lg:my-2'>
                            ...
                            <div>
                                ...
                                <div className='w-[100px] h-[100px] relative border-[1px] solid border-second rounded-[10px]'>
                                    <Image src={item.mapLocation? item.mapLocation : MapPreserve_Pic} alt="MapPic" className='w-full h-full'/>
                                    {!item.mapLocation && 
                                        <p className='text-sm text-error text-center font-medium leading-4 absolute top-[40%] left-[15%]'>ثبت روی نقشه</p>}    
                                </div>
                            </div>
                        </div>
                        <div className='flex flex-row-reverse items-center text-right font-semibold lg:font-bold opacity-90 leading-8 my-2'>
                        ...
                        <label htmlFor="More-modal" className="modal cursor-pointer">
                            <label className="modal-box w-full absolute lg:relative inset-x-0 bottom-0 mx-auto p-0 bg-white rounded-none">
                                <div className='w-full flex flex-col justify-between items-end'>  
                                    <label htmlFor='Trash-modal'
                                        className="w-full flex flex-row-reverse items-center px-10 py-4 border-b-[1px] border-gray-400 solid"
                                    >
                                        <Image src={TrashRed_Icon} alt="TrashIcon" width={15} height={15}/>
                            ...
                            <label className="modal-box w-full absolute lg:relative inset-x-0 bottom-0 px-10 py-4 lg:p-8 mx-auto bg-white rounded-none rounded-t-[15px] lg:rounded-[20px]">                
                                <div className='w-full flex flex-col justify-between items-stretch'>
                                    <div className='w-full flex flex-row-reverse justify-between items-center'>
                                        <p className='text-lg text-black font-medium lg:font-bold leading-7 after:hidden lg:after:inline-block after:w-2 after:h-4 after:bg-first after:text-first after:content-[""] after:ml-2 after:align-middle after:rounded-[2px]'>حذف آدرس</p>
                                        <label htmlFor="Trash-modal">
                                    ...
                                    <div className='flex flex-row-reverse items-center justify-between w-full lg:w-1/2'>
                                        <label htmlFor='Trash-modal' onClick={() => TrashHandler(index)} className='w-full text-sm text-white text-center font-semibold py-3 lg:py-2 lg:px-8 rounded-[5px] bg-error ml-2 border-[2px] solid border-error'>حذف آدرس</label>
                                        <label htmlFor="Trash-modal" className='w-full text-sm text-error text-center font-semibold py-3 lg:py-2 rounded-[5px] bg-white border-[2px] solid border-error'>انصراف</label>
                                    </div>
                                </div>
                            </label>
                        </label>
                ...
                <div className='w-full flex flex-row lg:flex-col justify-center items-start lg:items-center mt-10 lg:mt-2 py-5 lg:py-10 bg-first lg:bg-white rounded-[12px] lg:rounded-[25px] shadow-shadowB'>
                    <Image src={LocationAdd_White_Icon} alt="LocationAddIcon" className='mr-2 lg:mr-0 lg:hidden'/>
                    <Image src={LocationAdd_Icon} alt="LocationAddIcon" className='hidden lg:block'/>
                    <p className='text-lg lg:text-3xl text-white lg:text-first text-center font-medium lg:font-bold leading-7 lg:mt-5'>ثبت آدرس جدید</p>
                </div>
            </div>
