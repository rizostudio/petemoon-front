      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between lg:p-10 lg:bg-white lg:rounded-[25px]">
          ...
          <div className="flex lg:hidden flex-col">
            <div className="pb-4">
              <div className="flex justify-between items-center my-1">
                ...
                <p className="text-base text-black font-medium lg:font-black leading-6 lg:mr-2">
                  <bdi>{data.visitCode}</bdi>
                </p>
              </div>
              <div className="flex justify-between items-center my-1">
                <p className="text-base text-gray-400  font-medium leading-6">
            ...
            <div className="py-4 border-b-[2px] border-secondary">
              ...
              <div className="flex justify-between items-center my-1">
                ...
                <div className="flex items-center">
                  <p className="text-sm text-info font-medium leading-6">
                    <bdi>{data.vetOrderPic}</bdi>
                  </p>
                  <button
          ...
          <div className="hidden lg:flex flex-col w-1/2">
            <p className="hidden lg:block text-lg text-black font-black leading-7 before:inline-block before:w-2 before:h-4 before:bg-primary before:rounded-[2px] before:ml-2">
              <bdi>شرح حال پزشک</bdi>
            </p>
            <div className="flex flex-row pt-7">
              <div className="flex flex-col">
                <div className="flex items-center my-2.5">
                  <p className="text-base text-black font-medium leading-6">
                    <bdi>تاریخ ویزیت:</bdi>
                  </p>
                  <p className="text-base text-black font-black leading-6 mr-1.5">
                    <bdi>{data.visitDate}</bdi>
                  </p>
                </div>
                <div className="flex items-center my-2.5">
              ...
              <div className="flex flex-col mr-10">
                ...
                <div className="flex items-center my-2.5 px-3 py-1.5 border-[1px] border-[#9B9BA1] rounded-[5px]">
                  ...
                  <p className="text-base text-info font-black leading-6 mr-1.5">
                    <bdi>{data.vetOrderPic}</bdi>
                  </p>
                </div>
              </div>
          ...
          <div className="w-full lg:w-1/2 lg:mr-10 xl:mr-[70px]">
            <div className="flex flex-col py-4">
              <p className="text-base text-gray-400 lg:text-black font-medium leading-6 lg:opacity-90">
                <bdi>خلاصه شرح حال پزشک:</bdi>
              </p>
              <p className="text-base text-black font-medium leading-7 pt-4 lg:px-4 lg:py-2 lg:mt-2 lg:opacity-70 lg:bg-[#F8F8F8] lg:border-[1px] lg:border-gray-400 lg:rounded-[5px]">
