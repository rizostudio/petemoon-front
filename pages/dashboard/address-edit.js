        ...
        <DashboardLayout>
            <div className='flex flex-col lg:bg-white lg:rounded-[25px] lg:px-12 lg:py-6'>
                <div className='w-full flex lg:hidden flex-row-reverse justify-between items-center mb-10'>
                    ...
                    <Link href='/dashboard/addresses' className='bg-first opacity-[0.8] p-4 rounded-[15px]'>
                        <Image src={ArrowLeftWhite_Icon} alt="ArrowIcon" className='w-full'/>
                    </Link>
                </div>
                <form onSubmit={formik.handleSubmit}
                    className='flex flex-col lg:flex-row-reverse justify-start lg:justify-between'
                >
                    <div className='flex flex-col items-stretch w-full lg:w-2/3'>
                        ...
                        <div className='lg:flex flex-row-reverse justify-between items-center w-full lg:my-5'>
                            ...
                            <div className='text-right lg:w-1/2 my-4 lg:m-1 lg:mr-4'>
                                <label className='hidden lg:block text-lg text-right text-black font-bold leading-8 opacity-90 after:hidden lg:after:inline-block after:w-2 after:h-4 after:bg-first after:ml-2 after:align-middle after:rounded-[2px]'>تحویل گیرنده</label>
                                <FloatLabelInput
                                    type={"text"}
                        ...
                        <div className='text-right my-4 lg:m-1'>
                            <label className='hidden lg:block text-lg text-right text-black font-bold leading-8 opacity-90 after:hidden lg:after:inline-block after:w-2 after:h-4 after:bg-first after:ml-2 after:align-middle after:rounded-[2px]'>آدرس پستی</label>
                            <FloatLabelInput
                                type={"text"}
                    ...
                    <div className='w-full lg:w-1/3 flex flex-col justify-between lg:justify-end items-stretch lg:mr-6'>
                        <div className='w-full h-[150px] relative my-4 lg:my-1 border-[1px] solid border-second lg:border-none rounded-[10px] lg:rounded-none overflow-hidden'>
                        ...
                        <div className='w-full flex flex-row mt-10 lg:mt-6'>
                            ...
                            <Link href={'/dashboard/addresses'} className='hidden lg:block text-lg text-error text-center font-medium leading-8 p-3 lg:ml-2 lg:px-4 border-[1px] solid border-error rounded-[5px]'>انصراف</Link>
                        </div>
                    </div>
                </form>
            </div>
