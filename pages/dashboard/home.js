    ...
    return (
        <DashboardLayout>
            <div className='flex flex-col items-stretch'>           
                <div className='flex flex-col lg:flex-row-reverse justify-between lg:justify-center items-stretch lg:items-center w-full h-full lg:h-[250px]'>
                ...
                <div className='flex flex-col lg:flex-row-reverse justify-center items-stretch lg:items-center w-full h-full lg:h-[250px] my-3 lg:my-5'>
                    <div className='h-[250px] lg:h-full w-full lg:w-3/4 flex flex-col justify-between items-center p-5 rounded-[15px] lg:rounded-[25px] text-white bg-gradient-to-r from-[#FA5456] to-[#FFA000] shadow-shadowB'>
                    ...
                    <div className='w-full lg:w-1/4 h-full flex flex-col justify-between items-stretch bg-white p-5 lg:mr-5 mt-3 lg:mt-0 rounded-[25px] shadow-shadowB'>
                        <Image src={CartTotal_Icon} alt="BagTickIcon" className="self-end"/>
                        <div className='self-end text-right'>
                ...
                <div className='block w-full bg-white rounded-[25px] shadow-shadowA'>
                    ...
                    <div className='flex flex-col lg:flex-row-reverse items-center justify-between w-full px-20 py-12'>
                        ...
                        <div className='px-1 py-0 flex items-center border-r-[2px] border-second lg:solid border-none'>
                            <div className='p-1 text-right'>
