...
const SingleProduct = () => {
    ...
    return (
        <div className='w-full h-full flex flex-col justify-between items-stretch bg-[#f8f8f8] lg:px-12 py-5'>
            {/*Heading for mobile */}
            ...
            {/* Coustomers comment   */}
            <div className='px-10 py-5 lg:px-0 lg:py-10 flex flex-col items-stretch border-solid border-b-[2px] border-secondary'>
                ...
                <label 
                    ...
                    className='text-base text-center text-primary font-bold leading-6 self-end w-1/3 lg:w-1/4 px-10 lg:px-20 py-2 border-solid border-[1px] border-primary rounded-[12px] lg:rounded-[15px]'
                >ثبت دیدگاه</label>
                {/* modal */}
                <div>
                    <input 
                        ...
                        <label className="modal-box w-full absolute lg:relative inset-x-0 bottom-0 px-10 py-4 lg:p-8 mx-auto bg-white rounded-none rounded-t-[15px] lg:rounded-[20px]">
                            ...
                            >
                                ...
                                <input 
                                    id="comment-subject"
                                    type="text"
                                    className="px-4 py-2 lg:w-3/4 mt-2 border-[1px] border-solid border-gray-400 rounded-[5px]"
                                />
                                <label
